...
public class Squad {
    ...
    public static Squad setUpNewSquad(){return new Squad("Avengers",15,"Infinity Stone");}
    public static Squad setUpNewSquad1(){return new Squad("Peaky Blinder",15,"Birmingham Victory");}
